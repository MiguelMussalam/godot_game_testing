...
load("res://Sound effects/Lanterna/som_lanterna-01.wav"),
load("res://Sound effects/Lanterna/som_lanterna-02.wav"),
load("res://Sound effects/Lanterna/som_lanterna-04.wav"),
load("res://Sound effects/Lanterna/som_lanterna-09.wav"),
load("res://Sound effects/Lanterna/som_lanterna-10.wav")
]
...
'''
------ ------ ------ ------ ------ ------ LEMBRETE ------ ------ ------ ------ ------ ------ 
Subída/descida de escadas precisa ser melhorada.
necessário: 
	1. Subir enquanto detecta degrau (saindo do chão), quando não detectar mais degrau...-
	Tocar som de passo e screen-shake.
	
	2. Ser mais lento do que o andar padrão.
	
	3. Iterar o global_position e não a porra do velocity.y que a merda do gemini fica falando
	
	4. Agora com descida de escada, talvez o melhor seja velocity.y, pela velocidade que iterar...-
	global_position geraria, como um boost de velocidade.
	
	5. também gerar o som de passo e screen shake quando descer cada degrau.
------ ------ ------ ------ ------ ------ LEMBRETE ------ ------ ------ ------ ------ ------ 
'''
